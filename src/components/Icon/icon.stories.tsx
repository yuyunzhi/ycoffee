    ...
    <div className="story-demo-box">
      <div className="story-demo-main">
        ...
        <div className="story-desc">
          ...
          <div>
            使用 theme 属性来定义 Icon 的主题。提供了8种: 'primary' ,
...
<Icon icon="arrow-alt-circle-right" theme='dark' size="3x" />`}
      ...
      <div className="story-demo-main">
        ...
        <div className="story-desc">
          <a className="story-desc-title">基础</a>
          <div>
            使用 icon 属性来定义 Icon 的图标内容。支持 fontawesome 所有
            free-solid-icons，可以在这里查看所有图标:
            <a
...
<Icon icon="lemon" theme='info'/>`}
      ...
      <div className="story-demo-main">
        ...
        <div className="story-desc">
          ...
          <div>
            支持 react-fontawesome的所有属性 可以在这里查询：
            <a
              href="https://github.com/FortAwesome/react-fontawesome#basic"
              target="_blank"
            >
              fontawesome
            </a>
      ...
      <table>
        <tbody>
          ...
          <tr>
            <th>theme</th>
            <th>
              可选主题色 ：'primary' | 'secondary' | 'success' | 'info' |
          ...
          <tr>
            <th>其他属性</th>
            <th>
              如：size,rotation,color，spin,pulse ……
