  ...
  <div className="story-container">
    ...
    <div className="story-demo-box">
      <div className="story-demo-main">
        <div className="story-content">
          <TransMenu onSelect={action("选择的是哪个？")} defaultName="a">
            <TransMenu.Item name="a">link0</TransMenu.Item>
            <TransMenu.Item name="b" disabled>
              link1
            </TransMenu.Item>
            <TransMenu.Item name="c">link2</TransMenu.Item>
            <TransMenu.SubMenu name="sub" title={"二级"}>
              <TransMenu.Item name="d">link3</TransMenu.Item>
              <TransMenu.Item name="e">link4</TransMenu.Item>
            </TransMenu.SubMenu>
          </TransMenu>
        </div>
        <div className="story-desc">
          ...
          <div>
            该组件拥有defaultName默认的激活的菜单属性 和 onSelect
            来监听选中的事件。使用name来标记哪个Item。拥有disabled来禁用某一项。
          </div>
        </div>
    ...
    <TransMenu.SubMenu name="sub" title={"二级"} >
      ...
      <div className="story-demo-main">
        <div className="story-content">
          <TransMenu
            onSelect={action("选择的是哪个？")}
            defaultName="a"
            mode="vertical"
            defaultOpenSubMenus={["sub"]}
          >
            <TransMenu.Item name="a">link0</TransMenu.Item>
            <TransMenu.Item name="b">link1</TransMenu.Item>
            <TransMenu.Item name="c">link2</TransMenu.Item>
            <TransMenu.SubMenu name="sub" title={"二级"}>
              <TransMenu.Item name="d">link3</TransMenu.Item>
              <TransMenu.Item name="e">link4</TransMenu.Item>
        ...
        <div className="story-desc">
          <a className="story-desc-title">基础</a>
          <div>
            该组件拥有mode属性设置样式水平或垂直，defaultOpenSubMenus
            属性设置默认展开项，仅限于垂直样式。监听选中的事件。
          </div>
        </div>
        <div className="story-code">
          <pre>
