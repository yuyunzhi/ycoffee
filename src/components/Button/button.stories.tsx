...
<Button btnType='link' href='https://www.baidu.com' target='_blank' > link </Button>`
            ...
            <div className='story-demo-main'>
                <div className='story-content'>
                    <div>
                        <Button btnType='primary' size='lg' style={{marginRight:'20px'}}> 大</Button>
                        <Button btnType='primary' style={{marginRight:'20px'}}> 中</Button>
                        <Button btnType='primary' size='sm' style={{marginRight:'20px'}}> 小</Button>
                    </div>
                </div>
                <div className='story-desc'>
...
<Button btnType='primary' size='sm'> 小 </Button>`
            ...
            <div className='story-demo-main'>
                <div className='story-content'>
                    <div>
                        <Button disabled style={{marginRight:'20px'}}> 禁用 </Button>
                        <Button btnType='primary' disabled style={{marginRight:'20px'}}> 禁用 </Button>
                        <Button btnType='danger' disabled style={{marginRight:'20px'}}> 禁用 </Button>
